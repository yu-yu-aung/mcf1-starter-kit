...
const GetStarted = () => {
    return (
        <div className="space-y-10 pb-40 py-30 text-foreground dark:bg-muted flex items-center flex-col justify-center bg-primary/10 relative w-screen left-1/2 -translate-x-1/2">

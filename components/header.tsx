...
export default function Header() {
  return (
    <header className="sticky top-0 flex h-16 items-center justify-between border-b bg-background px-4 md:px-6 mx-auto">
      <Link
        href="#"
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <Button
          className="hidden md:inline-flex rounded-lg p-3"
          variant="outline"
          size="lg"
        >
          Sign In
